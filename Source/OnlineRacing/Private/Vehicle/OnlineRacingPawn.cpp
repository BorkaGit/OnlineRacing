...
{
	AOnlineRacingMatchPlayerController* const OnlineRacingMatchPlayerController = Cast<AOnlineRacingMatchPlayerController>(GetController());
	if (IsValid(OnlineRacingMatchPlayerController))
	{
		OnlineRacingMatchPlayerController->RequestVehicleRespawn();
		return;
	}
