...
#include "OnlineRacingMatchPlayerController.generated.h"
...
class AOnlineRacingMatchPlayerController : public APlayerController
{
	GENERATED_BODY()
...
private:
	...
	TWeakObjectPtr<AOnlineRacingPlayerState> RacePlayerState;
